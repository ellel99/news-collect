...
Only after all M2 gates are accepted may a separately authorized real AI benchmark begin. This milestone does not
authorize AI runtime, investment advice, Portfolio, Market Validation, additional Providers, or PR #39 changes.
M2-A consolidates the explicitly selected R3–R6 operation expansions; it does not declare the entire original
provider catalogs, R7 official-source expansion, or R8 completeness finished.

Implementation authority in this command is limited to [M2-A](SPEC-0045-m2a-four-provider-data-breadth.md).
Production migration, target activation, cutover, Migration B and live verification remain separate gates.
