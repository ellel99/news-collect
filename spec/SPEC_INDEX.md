...
Active SPEC：SPEC-0032（Implementation Review；manual Marketaux real collection pipeline only）
...
| SPEC-0032 | Marketaux Real Collection Pipeline | Active — Implementation Review | SPEC-0026–0030 |
...
SPEC-0030 与 bundled SPEC-0031 已由 PR #30 完成。唯一 Active SPEC 是 SPEC-0032，只实现 manual
Marketaux real adapter → CollectionRunner → RawItem → evidence_items pipeline；
