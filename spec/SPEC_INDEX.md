...
Active SPEC：SPEC-0030（Combined Implementation Review；含 bundled SPEC-0031 smoke harness）
...
| SPEC-0030 | Marketaux Real Adapter Implementation | Active — Implementation Review | SPEC-0025/0026/0029 implementation |
| SPEC-0031 | Marketaux Bounded Live Smoke Harness | Bundled — Implementation Review in PR #30；not separately Active | SPEC-0030 |
...
唯一 Active SPEC 是 SPEC-0030 combined delivery，只实现 Marketaux real adapter/request/credential/HTTP
code boundary 与 bundled SPEC-0031 manual bounded smoke harness；
不授权真实 API 执行、scheduler 或其他 Provider。SPEC-0005 及其他
