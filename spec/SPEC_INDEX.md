...
Active SPEC：SPEC-0038（Implementation Review；multi-provider scheduler + Telegram routing）
...
| SPEC-0038 | Multi-provider Scheduler + Telegram Routing | Active — Implementation Review | SPEC-0035/0037 |
...
SPEC-0030–0037 已完成。唯一 Active SPEC 是 SPEC-0038，只将 Marketaux/Finnhub/EIA/SEC 接入
最小独立 cadence scheduler 与 provider-specific Telegram routing；不授权 AI、investment
recommendation 或 formal dedup/Event。SPEC-0005 及其他
