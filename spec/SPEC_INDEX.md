...
| SPEC-0041 | Unified Production Collection Control Plane | Active — Docs Review + Foundation Revision Review；implementation blocked pending v2.3 Freeze Review | SPEC-0003/0030–0038；Pre-AI R0 gate；PR #39 frozen |
...
v2.2-FROZEN 生效。v2.3 Draft Freeze Review 仍 PENDING；SPEC-0041 不授权代码或 migration。
