...
Active SPEC：SPEC-0039（Docs Review + Foundation Freeze Review；implementation gated）
...
| SPEC-0039 | Phase 1 Acceptance + Event Candidate Foundation | Active — Docs Review / Foundation Freeze Review required | SPEC-0018–0021/0023–0038 |
...
SPEC-0030–0038 已完成。唯一 Active SPEC 是 SPEC-0039 Docs Review / Foundation Freeze Review；在两项
Review PASS 前不得编写 migration/ORM/Event implementation。SPEC-0005 及其他 Planned/candidate SPEC
均未激活；SPEC-0022 已被 SPEC-0039 absorb/supersede，不得作为竞争实现单独激活。
