...
Active SPEC：SPEC-0030（Implementation Review；Marketaux real adapter code boundary only）
...
唯一 Active SPEC 是 SPEC-0030，只实现 Marketaux real adapter/request/credential/HTTP code boundary；
