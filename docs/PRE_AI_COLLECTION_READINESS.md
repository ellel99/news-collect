...
Current gate：R0/R1/R2/R8-A/M2-A/M2-B Completed；M2-C Active — Draft Implementation Review；production authority remains `legacy`；
...
[M2 milestone](../spec/SPEC-0044-m2-ai-ready-evidence-data-plane.md). M2-B Packet is complete in main;
M2-C Bundle is implemented in a Draft PR and M2-D Readiness
