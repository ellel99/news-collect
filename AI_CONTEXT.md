...
- 当前 Active SPEC：`spec/SPEC-0019-evidence-contract-implementation-scaffold.md`
- 最近完成：SPEC-0003，tag `spec-0003-completed`
- 当前工作状态：SPEC-0019 Evidence Contract Implementation Scaffold Review；只允许 pure
  enums/frozen dataclasses/validation helpers，no IO/network/DB
...
- 下一步：只审核 SPEC-0019 pure evidence contract scaffold；不得请求 Provider、读取 local
  capture、实现 Adapter/DB/collection/正式 normalization/dedup/Event/AI
...
- SPEC-0019 不定义 DB schema/ORM，不实现 Adapter、collection、正式 normalization/dedup、Event
  或 AI；SPEC-0020–0022 仍为非 Active 候选
