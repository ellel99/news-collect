...
- 开发入口：[`spec/SPEC-0028-rawitem-evidence-projection-trigger.md`](spec/SPEC-0028-rawitem-evidence-projection-trigger.md)，仅实现 Marketaux synthetic projection store/reader/explicit trigger
...
- Foundation：v2.1-FROZEN
- 当前阶段：Phase 1 — Information Collection & Push
- Active SPEC：[`spec/SPEC-0028-rawitem-evidence-projection-trigger.md`](spec/SPEC-0028-rawitem-evidence-projection-trigger.md) — Implementation Review
...
- SPEC-0019 pure contract scaffold 与 SPEC-0020 provider mapping scaffold 已 Completed；SPEC-0021
  ...
  orchestration implementation 也已 Completed。当前只实现 Marketaux synthetic content-free
  projection store、RawItem safe reader 与 explicit pipeline trigger；不实现真实 API Adapter、scheduler
