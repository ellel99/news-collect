...
def inventory() -> MigrationInventory:
    return MigrationInventory(("0001", "0002", "0003", "0004"), ("0004",), True)


def test_database_revision_at_head_passes() -> None:
    report = assess_alembic_state("0004", inventory(), True, 0)
...
def test_repository_inventory_is_linear_and_contains_0003() -> None:
    ...
    assert report.revisions == ("0001", "0002", "0003", "0004")
    assert report.code_heads == ("0004",)
...
async def test_dry_run_does_not_modify_compatible_database(
    ...
    assert report.target_head == "0004"
...
async def test_execute_repairs_only_compatible_database_to_code_head(
    ...
    assert report.database_revision_after == "0004"
    assert version == "0004"
